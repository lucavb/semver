...
function runExecutor(_a) {
    return tslib_1.__awaiter(this, arguments, void 0, function* ({ tag, files, notes, notesFile, target, draft, title, prerelease, discussionCategory, repo, generateNotes, notesStartTag, }) {
