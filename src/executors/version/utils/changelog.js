...
const write_changelog_1 = require("./write-changelog");
...
/* istanbul ignore next */
function updateChangelog({ projectRoot, dryRun, preset, newVersion, changelogHeader, tagPrefix, commitParserOptions, }) {
    return (0, rxjs_1.defer)(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const changelogPath = getChangelogPath(projectRoot);
        yield (0, write_changelog_1.default)({
            changelogHeader,
            changelogPath,
            dryRun,
            projectRoot,
...
function calculateChangelogChanges({ changelogPath, changelogHeader, }) {
    return (source) => {
        return (0, filesystem_1.readFileIfExists)(changelogPath, changelogHeader).pipe((0, rxjs_1.combineLatestWith)(source), (0, rxjs_1.concatMap)((_a) => tslib_1.__awaiter(this, [_a], void 0, function* ([input]) {
