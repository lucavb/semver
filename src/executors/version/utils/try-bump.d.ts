 ...
 */
export declare function tryBump({ commitParserOptions, preset, projectRoot, tagPrefix, dependencyRoots, releaseType, preid, versionTagPrefix, syncVersions, allowEmptyRelease, skipCommitTypes, projectName, workspace, visitedProjects, }: {
...
export declare function _semverBump({ since, preset, projectRoot, tagPrefix, releaseType, preid, commitParserOptions, }: {
    since: string;
    preset: PresetOpt;
    projectRoot: string;
    tagPrefix: string;
...
export declare function _getDependencyVersions({ commitParserOptions, preset, dependencyRoots, releaseType, versionTagPrefix, syncVersions, lastVersionGitRef, skipCommitTypes, projectName, preid, workspace, visitedProjects, }: {
    commitParserOptions?: CommitParserOptions;
    preset: PresetOpt;
