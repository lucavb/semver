...
function _normalizeOptions(options) {
    var _a, _b, _c;
    return Object.assign(Object.assign({}, options), { push: options.push, remote: options.remote, dryRun: options.dryRun, trackDeps: options.trackDeps, baseBranch: options.baseBranch, noVerify: options.noVerify, syncVersions: options.syncVersions, skipRootChangelog: options.skipRootChangelog, skipProjectChangelog: options.skipProjectChangelog, allowEmptyRelease: options.allowEmptyRelease, skipCommitTypes: options.skipCommitTypes, releaseAs: (_a = options.releaseAs) !== null && _a !== void 0 ? _a : options.version, changelogHeader: (_b = options.changelogHeader) !== null && _b !== void 0 ? _b : changelog_1.defaultHeader, versionTagPrefix: (_c = options.tagPrefix) !== null && _c !== void 0 ? _c : options.versionTagPrefix, commitMessageFormat: options.commitMessageFormat, commitParserOptions: options.commitParserOptions, skipCommit: options.skipCommit, preset: options.preset === 'conventional'
            ? 'conventionalcommits'
