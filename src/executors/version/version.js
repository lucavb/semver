...
function versionWorkspace(_a) {
    var { skipRootChangelog, commitMessage, newVersion, dryRun, noVerify, projectName, tag, skipCommit, skipStage, projectRoot } = _a, options = tslib_1.__rest(_a, ["skipRootChangelog", "commitMessage", "newVersion", "dryRun", "noVerify", "projectName", "tag", "skipCommit", "skipStage", "projectRoot"]);
...
function versionProject(_a) {
    var { workspaceRoot, projectRoot, newVersion, dryRun, commitMessage, noVerify, tagPrefix, projectName, skipCommit, skipStage, tag } = _a, options = tslib_1.__rest(_a, ["workspaceRoot", "projectRoot", "newVersion", "dryRun", "commitMessage", "noVerify", "tagPrefix", "projectName", "skipCommit", "skipStage", "tag"]);
    ...
    changelogPaths.length === 1
        ...
        }).pipe((0, operators_1.concatMap)((changelogPath) => (0, git_1.addToStage)({ paths: [changelogPath], dryRun, skipStage })))
